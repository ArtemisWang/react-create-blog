...
import '../static/style/components/author'
    ...
    return (
        <div className="author-div comm-box">
            ...
            <div className="author-introduction">
                ...
                <Avatar size={28} icon="github" className="acount"/>
                <Avatar size={28} icon="qq" className="acount"/>
                <Avatar size={28} icon="wechat" className="acount"/>
            </div>
        </div>
    )
}
